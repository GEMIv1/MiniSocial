...
@Stateless(name="joinProducer")
@Local(notificationProducer.class)
public class notificationJoinProducer extends notificationProducer{
    ...
    public void notify(Integer recipientUserId, Integer actorId, Integer postId, Integer grpId) {
		try (JMSContext ctx = context()) {
            ...
            msg.setString("type",   NotificationType.GROUP_JOIN_REQUEST.name());
